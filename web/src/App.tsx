...
import type { Document, GenerationResult, KnowledgeSource, OutlineItem, Project, QualityGenerationResult } from './types'

type WorkspaceTab = 'documents' | 'structure' | 'generation' | 'knowledge' | 'quality' | 'runs'
  ...
  return <div className="workspace-layer">
    ...
    <div className="workspace-body">
      ...
      <section className="workspace-content">
        ...
        </> : tab === 'runs' ? <AIRunsPanel project={project} /> : <>
