    ...
    <div className={workspaceNavCollapsed?'workspace-body nav-collapsed':'workspace-body'}>
      ...
      <section className="workspace-content">
        {tab === 'documents' ? <>
          ...
          {documentMode==='generator'?<ChapterDocumentGenerator project={project} documents={documents.data?.items??[]} modelReady={modelStatus.data?.generationOperations??[]} onOpenDocument={document=>{setSelectedDocument(document);setDocumentMode('library')}}/>:<div className={documentBrowserCollapsed?'document-workbench browser-collapsed':'document-workbench'}>
